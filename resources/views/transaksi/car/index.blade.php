...
<div class="row">
    ...
    <div class="col-lg-2">
        <a href="{{ route('sewa.create') }}" class="btn btn-primary btn-rounded btn-fw"><i class="fa fa-plus"></i> Sewa Mobil </a>
    </div>
    <div class="col-lg-12">
                                ...
                                <td>
                                    ...
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 30px, 0px);">
                                            ...
                                            <form action="{{ route('sewa.update', $data->id) }}" method="post" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                {{ method_field('put') }}
                                            ...
                                            @endif
                                            <form action="{{ route('sewa.destroy', $data->id) }}" class="pull-left" method="post">
                                                {{ csrf_field() }}
                                                {{ method_field('delete') }}
